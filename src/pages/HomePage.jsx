    ...
    return (
        ...
        <div className="min-h-screen bg-white/60 dark:bg-black/10 text-gray-900 dark:text-white transition-colors duration-300 backdrop-blur-sm">
            ...
            <h1 className="text-5xl font-bold mb-4 leading-tight text-gray-500 dark:text-gray-100">
                Tedra  
                <span className="block mt-2 text-indigo-500 text-xl md:text-2xl font-mono">
                    <Typewriter
            ...
            <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-6 dark:text-gray-100">
            ...
            <div className="flex justify-center gap-6 mt-4">
                ...
                <FaLinkedin className="text-3xl text-indigo-500 hover:text-gray-600 transition duration-300" />
                </a>
                {/* Github */}
                <a href="https://github.com/tbirch5" target="_blank" rel="noopener noreferrer">
                <FaGithub className="text-3xl text-indigo-500 hover:text-gray-600 transition duration-300" />
                </a>
                {/* Resume with preview */}
                <div className="relative group">
                <a href="/Tedra_Resume.pdf" target="_blank" rel='noopener noreferrer'>
                    <HiDocumentText className="text-3xl text-indigo-500 hover:text-gray-600 transition duration-300" />
                </a>
            ...
            {/* About Section */}
            <section id="about" className="bg-white/20 dark:bg-black/30 backdrop-blur-md">
            ...
            {/* Contact Section */}
            <section id="contact" className="bg-white/20 dark:bg-black/10 backdrop-blur-md">
